...
if ($mysqli->select_db($dbname)) {
    ...
    echo "Error selecting database '$dbname': " . $mysqli->error . "<br>";
}
...
if ($mysqli->query($tableQuery) === TRUE) {
    echo "Table 'inventory' created or already exists.<br>";
} else {
    echo "Error creating table: " . $mysqli->error . "<br>";
}

$insertQuery = "INSERT IGNORE INTO inventory (VIN, YEAR, Make, Model, TRIM, EXT_COLOR, INT_COLOR, ASKING_PRICE, SALE_PRICE, PURCHASE_PRICE, MILEAGE, TRANSMISSION, PURCHASE_DATE, SALE_DATE) 
VALUES ('1FAFP44423F44657', 2003, 'Ford', 'Mustang', 'Base', 'Silver / Black', 'Gray', 8995, NULL, 6746, 75820, 'Automatic', '2013-01-14', NULL),
...
if ($mysqli->query($insertQuery) === TRUE) {
    echo "<p>Sample cars inserted into inventory table.</p>";
} else {
    echo "<p>Error inserting cars: </p>" . $mysqli->error . "<br>";
}
