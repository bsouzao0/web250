...
$query = "INSERT INTO `if0_38812485_cars`.`inventory` 
...
$query3 = "INSERT INTO `if0_38812485_cars`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`)
 VALUES
...
{
echo $mysqli->error;
    echo "<p>Error Inserting 27 cars: ". $mysqli->error; "</p>";
    echo "<p>***********</p>";
    echo $query3;
    echo "<p>***********</p>";
}
